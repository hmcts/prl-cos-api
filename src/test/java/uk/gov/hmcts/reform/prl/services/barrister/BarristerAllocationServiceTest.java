...
class BarristerAllocationServiceTest {
    ...
    private static final String PARTY_ID = "c0651c7d-0db9-47aa-9baa-933013f482f";
    private static final String SOL_PARTY_ID = "c0651c7d-0db9-47aa-9baa-933013f482e";
    ...
    void shouldGetAllocatedBarrister() {
        ...
        assertEquals(PARTY_ID + "1", appParty1.getCode());
        ...
        assertEquals(PARTY_ID + "2", appParty2.getCode());
        ...
        assertEquals(PARTY_ID + "4", resParty1.getCode());
        ...
        assertEquals(PARTY_ID + "5", resParty2.getCode());
    }
    ...
    private Element<PartyDetails> buildPartyDetails(String id, String appFirstName, String appLastName, boolean hasRep,
        ...
        return Element.<PartyDetails>builder().id(UUID.fromString(PARTY_ID + id))
            .value(PartyDetails.builder()
                       .partyId(UUID.fromString(PARTY_ID + id))
                       .firstName(appFirstName)
                       .lastName(appLastName)
                       .doTheyHaveLegalRepresentation(hasRep ? YesNoDontKnow.yes : null)
                       .solicitorPartyId(hasRep ? UUID.fromString(SOL_PARTY_ID + id) : null)

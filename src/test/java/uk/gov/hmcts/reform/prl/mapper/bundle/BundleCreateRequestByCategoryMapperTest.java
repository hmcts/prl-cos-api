...
class BundleCreateRequestByCategoryMapperTest {
    ...
    void mapCaseDataToBundleCreateRequest() {
        ...
        furtherEvidences.add(FurtherEvidence.builder().typeOfDocumentFurtherEvidence(FurtherEvidenceDocumentType.miamCertificate)
                                 .documentFurtherEvidence(Document.builder().documentUrl("url").documentBinaryUrl("url")
                                                              .documentFileName("Sample1.pdf").build())
        ...
        otherDocuments.add(OtherDocuments.builder().documentName("Application docu")
                               .documentOther(Document.builder().documentUrl("url").documentBinaryUrl("url")
                                                  .documentFileName("Sample2.pdf").build()).documentTypeOther(
        ...
        citizenC7uploadedDocs.add(ResponseDocuments.builder()
                                      .citizenDocument(Document.builder().documentUrl("url").documentBinaryUrl("url")
                                                           .documentFileName("C7Document.pdf").build()).build());

        List<UploadedDocuments> uploadedDocuments = new ArrayList<>();
        uploadedDocuments.add(UploadedDocuments.builder()
                                  .citizenDocument(Document.builder().documentUrl("url").documentBinaryUrl("url")
                                                       .documentFileName("PositionStatement.pdf").build())
        ...
        uploadedDocuments.add(UploadedDocuments.builder()
                                  .citizenDocument(Document.builder().documentUrl("url").documentBinaryUrl("url")
                                                       .documentFileName("WitnessStatement.pdf").build())
        ...
        uploadedDocuments.add(UploadedDocuments.builder()
                                  .citizenDocument(Document.builder().documentUrl("url").documentBinaryUrl("url")
                                                       .documentFileName("LettersFromSchool.pdf").build())
        ...
        fl401UploadWitnessDocuments.add(Document.builder().documentUrl("url").documentBinaryUrl("url")
                                            .documentFileName("witnessDoc.pdf").build());

        List<Document> fl401UploadSupportingDocuments = new ArrayList<>();
        fl401UploadSupportingDocuments.add(Document.builder().documentUrl("url").documentBinaryUrl("url")
                                               .documentFileName("supportingDoc.pdf")
                                               .build());

        List<ManageDocuments> otherManageDocuments = new ArrayList<>();
        otherManageDocuments.add(ManageDocuments.builder()
                                     .document(Document.builder().documentUrl("url").documentBinaryUrl("url")
                                                   .documentFileName("position.pdf")
                                                   .build())
                                     .documentCategories(DynamicList.builder()
                                                             .value(DynamicListElement.defaultListItem("Position statements"))
                                                             .build())
                                     .documentParty(DocumentPartyEnum.APPLICANT)
                                     .build());
        otherManageDocuments.add(ManageDocuments.builder()
                                     .document(Document.builder().documentUrl("url").documentBinaryUrl("url")
                                                   .documentFileName("witness.pdf")
                                                   .build())
                                     .documentCategories(DynamicList.builder()
        ...
        QuarantineLegalDoc drugTest = QuarantineLegalDoc.builder()
            ...
            .documentParty("Applicant").categoryName("Drug and alcohol test (toxicology)")
            .categoryId("drugAndAlcoholTest(toxicology)").build();

...
public class DocumentGenServiceTest {
    ...
    public void setUp() {
        ...
        Element<ApplicantConfidentialityDetails> applicantConfidential =
        ...
        OtherPersonConfidentialityDetails otherPersonConfidentialityDetails =
            uk.gov.hmcts.reform.prl.models.complextypes.confidentiality
    ...
    public void generateDocsForC100Test() throws Exception {
        ...
        c100CaseData = c100CaseData.toBuilder().allegationOfHarmRevised(AllegationOfHarmRevised
                                                                            .builder().newAllegationsOfHarmYesNo(Yes)
                                                                            .build()).allegationOfHarm(
            null).build();
        ...
        Map<String, Object> stringObjectMap =
            documentGenService.createUpdatedCaseDataWithDocuments(AUTH_TOKEN, c100CaseData);
    ...
    public void generateDocsForC100TestFinalDoc() throws Exception {
        ...
        Map<String, Object> stringObjectMap =
            documentGenService.createUpdatedCaseDataWithDocuments(AUTH_TOKEN, c100CaseDataFinal);
    ...
    public void generateDraftDocsForC100Test() throws Exception {
        ...
        ArgumentCaptor<CaseDetails> cd = ArgumentCaptor.forClass(CaseDetails.class);
        verify(dgsService, atLeastOnce()).generateDocument(anyString(), cd.capture(), any());
        assertEquals(
            c100CaseData.getCaseSolicitorName(),
            cd.getValue().getCaseData().getCaseSolicitorName()
        );
    ...
    public void generateDocsForC100TestWithC1A() throws Exception {
        ...
        when(allegationOfHarmRevisedService.updateChildAbusesForDocmosis(Mockito.any(CaseData.class))).thenReturn(
            c100CaseDataC1A);
        Map<String, Object> stringObjectMap =
            documentGenService.createUpdatedCaseDataWithDocuments(AUTH_TOKEN, c100CaseDataC1A);
    ...
    public void generateDocsForFL401TestWithChildConfidentialInfo() throws Exception {
        ...
        Map<String, Object> stringObjectMap =
            documentGenService.createUpdatedCaseDataWithDocuments(AUTH_TOKEN, fl401CaseData1);
    ...
    public void testDeleteDocumentException() {
        doThrow(new RuntimeException("Exception while delete document")).when(uploadService).deleteDocument(
            any(),
            any()
        );
        ...
        assertExpectedException(
            () -> {
                documentGenService
                    .deleteDocument(AUTH_TOKEN, "TEST_DOCUMENT_ID");
    ...
    @Test
    public void testCreateUpdatedCaseDataWithDocumentsForCitizenSubmissionForEnglish() throws Exception {
    ...
    public void generateDocsForC100CaseNotIssued() throws Exception {
        ...
        Map<String, Object> stringObjectMap =
            documentGenService.createUpdatedCaseDataWithDocuments(AUTH_TOKEN, c100CaseDataNotIssued);
    ...
    @Test
    public void createUpdatedCaseDataWithDocumentsForTestingSupportForC100Test() throws Exception {
    ...
    @Test
    public void createUpdatedCaseDataWithDocumentsForTestingSupportForFL401TestWithOrganisation() throws Exception {
        DocumentLanguage documentLanguage = DocumentLanguage.builder().isGenEng(true).isGenWelsh(true).build();
        when(documentLanguageService.docGenerateLang(Mockito.any(CaseData.class))).thenReturn(documentLanguage);
        doReturn(generatedDocumentInfo).when(dgsService).generateDocument(
            Mockito.anyString(),
    ...
    @Test
    public void createUpdatedCaseDataWithDocumentsForTestingSupportForFL401Test() throws Exception {
        DocumentLanguage documentLanguage = DocumentLanguage.builder().isGenEng(true).isGenWelsh(true).build();
        when(documentLanguageService.docGenerateLang(Mockito.any(CaseData.class))).thenReturn(documentLanguage);
        doReturn(generatedDocumentInfo).when(dgsService).generateDocument(
            Mockito.anyString(),
    ...
    @Test
    public void testSupportC8ConfidentialityNoOrders() throws Exception {
        generatedDocumentInfo = GeneratedDocumentInfo.builder()
            .url("TestUrl")
            .binaryUrl("binaryUrl")
            .hashToken("testHashToken")
    ...
    @Test
    public void testCreateUpdatedCaseDataWithDocumentsForTestingSupportDocsNullValueWhenAbsent() throws Exception {
        generatedDocumentInfo = GeneratedDocumentInfo.builder()
            .url("TestUrl")
            .binaryUrl("binaryUrl")
            .hashToken("testHashToken")
    ...
    public void testForConvertToPdfException() {
        ...
        assertExpectedException(
            () -> {
                documentGenService
                    .convertToPdf(AUTH_TOKEN, document);
    ...
    @Test
    public void testIsAnyC100_ApplicantInfoConfidential_applicantsNull_returnsFalse() {
        CaseData caseData = CaseData.builder()
    ...
    @Test
    public void testIsAnyC100_ApplicantInfoConfidential_allNo_returnsFalse() {
        PartyDetails applicant = PartyDetails.builder()
    ...
    @Test
    public void testIsAnyC100_ApplicantInfoConfidential_addressYes_returnsTrue() {
        PartyDetails applicant = PartyDetails.builder()
            .isAddressConfidential(YesOrNo.Yes)
            .isEmailAddressConfidential(YesOrNo.No)
            .isPhoneNumberConfidential(YesOrNo.No)
    ...
    @Test
    public void testIsAnyC100_ApplicantInfoConfidential_emailYes_returnsTrue() {
        PartyDetails applicant = PartyDetails.builder()
            .isAddressConfidential(YesOrNo.No)
            .isEmailAddressConfidential(YesOrNo.Yes)
            .isPhoneNumberConfidential(YesOrNo.No)
    ...
    @Test
    public void testIsAnyC100_ApplicantInfoConfidential_phoneYes_returnsTrue() {
        PartyDetails applicant = PartyDetails.builder()
            .isAddressConfidential(YesOrNo.No)
            .isEmailAddressConfidential(YesOrNo.No)
            .isPhoneNumberConfidential(YesOrNo.Yes)
    ...
    @Test
    public void testIsAnyC100_ApplicantInfoConfidential_multipleApplicants_oneYes_returnsTrue() {

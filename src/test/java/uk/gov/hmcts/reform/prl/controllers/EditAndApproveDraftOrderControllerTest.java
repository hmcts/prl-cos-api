...
public class EditAndApproveDraftOrderControllerTest {
    ...
    public void shouldGenerateDraftOrderDropdown() {
        ...
        when(draftAnOrderService.getDraftOrderDynamicList(caseData, caseDataMap)).thenReturn(caseDataMap);
    ...
    public void  shouldPopulateCommonFields() throws Exception {
        ...
        when(objectMapper.convertValue(stringObjectMap, CaseData.class)).thenReturn(caseData);
        when(draftAnOrderService.populateCommonDraftOrderFields(authorisation, caseData,
                                                                Event.DRAFT_AN_ORDER.getId(),
                                                                caseDataMap)).thenReturn(caseDataMap);
        when(authorisationService.isAuthorized(any(),any())).thenReturn(true);
        AboutToStartOrSubmitCallbackResponse response = editAndApproveDraftOrderController

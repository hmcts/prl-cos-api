...
public class ServiceOfApplicationServiceTest {
    ...
    @Test
    public void testEmailNotificationWhenPreferenceSetToEmailForSoaServeToRespondentOptionsNoC100() {
        PartyDetails partyDetails = PartyDetails.builder().representativeFirstName("repFirstName")
            .representativeLastName("repLastName")
            .gender(Gender.male)
            .email("abc@xyz.com")
    ...
    @Test
    public void testPostNotificationWhenNoAddressLineSetForSoaServeToRespondentOptionsNoC100() {
        PartyDetails partyDetails = PartyDetails.builder().representativeFirstName("repFirstName")
            .representativeLastName("repLastName")
            .gender(Gender.male)
            .email("abc@xyz.com")
    ...
    @Test
    public void testPostNotificationWhenNoPreferenceSetForSoaServeToRespondentOptionsNoC100() {
        PartyDetails partyDetails = PartyDetails.builder().representativeFirstName("repFirstName")
            .representativeLastName("repLastName")
            .gender(Gender.male)
            .email("abc@xyz.com")
    ...
    @Test
    public void testPostNotificationWhenPreferenceSetToEmailButNoEmailPopulatedForRespondentOptionsNoC100() {
        PartyDetails partyDetails = PartyDetails.builder().representativeFirstName("repFirstName")
            .representativeLastName("repLastName")
            .gender(Gender.male)
            .phoneNumber("1234567890")
    ...
    @Test
    public void testPostNotificationWhenPreferenceSetToPostForSoaServeToRespondentOptionsNoC100() {
        PartyDetails partyDetails = PartyDetails.builder().representativeFirstName("repFirstName")
            .representativeLastName("repLastName")
            .gender(Gender.male)
            .email("abc@xyz.com")
    ...
    @Test
    public void testEmailToRespondentNonPersonalAfterConfSuccessWhenPreferenceIsEmail() {
    ...
    @Test
    public void testPostToRespondentNonPersonalAfterConfSuccessWhenPreferenceIsEmailButNoEmailSet() {
    ...
    @Test
    public void testPostToRespondentNonPersonalAfterConfSuccessWhenPreferenceIsPostWithAddress() {

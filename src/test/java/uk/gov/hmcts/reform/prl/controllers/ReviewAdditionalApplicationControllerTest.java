...
public class ReviewAdditionalApplicationControllerTest {
    ...
    @Test
    public void testReviewAdditionalApplicatonMidEventWhenNoError() {
        Element<AdditionalApplicationsBundle> reviewAdditionalApplicationElement = Element.<AdditionalApplicationsBundle>builder().build();
        List<Element<AdditionalApplicationsBundle>> reviewAdditionalApplicationCollection = new ArrayList<>();
        reviewAdditionalApplicationCollection.add(reviewAdditionalApplicationElement);
        CaseData caseData = CaseData.builder()
        ...
        when(authorisationService.isAuthorized(any(),any())).thenReturn(true);
        when(objectMapper.convertValue(stringObjectMap, CaseData.class)).thenReturn(caseData);
        when(sendAndReplyService.populateDynamicListsForSendAndReply(any(CaseData.class), anyString(), eq(false), eq(null))).thenReturn(caseData);
    ...
    @Test
    public void testReviewAdditionalApplicatonMidEventWhenError() {
        Element<AdditionalApplicationsBundle> reviewAdditionalApplicationElement = Element.<AdditionalApplicationsBundle>builder().build();
        List<Element<AdditionalApplicationsBundle>> reviewAdditionalApplicationCollection = new ArrayList<>();
        reviewAdditionalApplicationCollection.add(reviewAdditionalApplicationElement);
        CaseData caseData = CaseData.builder()
    ...
    @Test
    public void testReviewAdditionalApplicatonMidEventWhenReviewIsNull() {
        Element<AdditionalApplicationsBundle> reviewAdditionalApplicationElement = Element.<AdditionalApplicationsBundle>builder().build();
        List<Element<AdditionalApplicationsBundle>> reviewAdditionalApplicationCollection = new ArrayList<>();
        reviewAdditionalApplicationCollection.add(reviewAdditionalApplicationElement);
        CaseData caseData = CaseData.builder()
    ...
    public void testReviewAdditionalApplicatonMidEventWhenReviewIsYes() {
        ...
        when(sendAndReplyService.populateDynamicListsForSendAndReply(caseData,auth, false, null)).thenReturn(caseData);

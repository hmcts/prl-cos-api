...
public class Fl401ListOnNoticeControllerTest {
    ...
    public void prepopulateHearingDetailsForFl401ListOnNotice() throws Exception {
        ...
        assertTrue(response.getData().containsKey("fl401ListOnNoticeHearingDetails"));
        assertTrue(response.getData().containsKey("legalAdviserList"));
    }
    ...
    public void shouldGenerateFL404bDocForListOnNotice() throws Exception {
        ...
        AboutToStartOrSubmitCallbackResponse response = fl401ListOnNoticeController
            .generateFl404bDocumentGeneration(authToken,callbackRequest);
        assertTrue(response.getData().containsKey("fl401ListOnNoticeDocument"));
    }

...
public class DraftAnOrderServiceTest {
    ...
    public void testToGetDraftOrderDynamicList() {
        ...
        stringObjectMap = draftAnOrderService.getDraftOrderDynamicList(caseData, "adminEditAndApproveAnOrder");
    ...
    public void testGetDraftOrderDynamicList() {
        ...
        Map<String, Object> caseDataMap = draftAnOrderService.getDraftOrderDynamicList(caseData, "adminEditAndApproveAnOrder");

...
public class AllTabServiceImplTest {
    ...
    public void testAllTabsServiceIncConfTabRefactored() {
        ...
        Element<ApplicantConfidentialityDetails> applicantConfidentialityDetailsElement = Element.<ApplicantConfidentialityDetails>builder()
            .value(ApplicantConfidentialityDetails.builder().build()).build();
        Element<ChildConfidentialityDetails> childConfidentialityDetailsElement = Element.<ChildConfidentialityDetails>builder()
            .value(ChildConfidentialityDetails.builder().build()).build();

...
public class TaskListServiceTest {
    ...
    @Test
    public void getTasksShouldReturnListOfTasksWithChildDetailsRevised() {

        CaseData caseData = CaseData.builder().caseTypeOfApplication(PrlAppsConstants.C100_CASE_TYPE)
            .isNewCaseCreatedFlagForChildDetails(YesOrNo.Yes).build();

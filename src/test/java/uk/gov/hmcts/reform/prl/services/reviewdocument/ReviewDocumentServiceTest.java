...
public class ReviewDocumentServiceTest {
    ...
    private uk.gov.hmcts.reform.ccd.document.am.model.Document testDocument() {
    ...
    public void testValidateEvent() {
        // given
        Map<String, Object> caseDataUpdated = Map.of("documentNewName", "123.pdf");

        // when
        List<String> result = reviewDocumentService.validateEvent(caseDataUpdated);
    ...
    public void testReviewProcessOfDocumentToConfidentialTabForScanDocWhenYesIsSelected() {
        ...
        assertNotNull(confidentialDocs.get(0).getValue().getUrl());
    ...
    public void testReviewForLegalProfDocsMoveToConfidentialDocsInConfTab() {
        ...
        List<Element<QuarantineLegalDoc>> restrictedDocs =
            (List<Element<QuarantineLegalDoc>>) caseDataMap.get(CONFIDENTIAL_DOCUMENTS);
        assertNotNull(restrictedDocs.get(0).getValue().getMiamCertificateDocument());
    ...
    @Test
    public void testSendEmailProcessForLegalProfRespAppRespC1aWhenDecisionNo() {
    ...
    public void testReviewProcessForAlwaysConfidentialCafcassDocTypesHaveConfidentialPrefixWhenDecisionNo() {
        ...
        for (String categoryId : cafcassCategoryIds) {
            ...
            assertNotNull("Category " + categoryId + " should NOT go to confidential tab", caseDataMap.get(CONFIDENTIAL_DOCUMENTS));
    ...
    @Test
    public void testGetDocumentDetailsWhenUploadedByCourtNavAndUploaderRoleNull() {
        element = Element.builder().id(UUID.fromString("33dff5a7-3b6f-45f1-b5e7-5f9be1ede355"))
            .value(UploadedDocuments.builder()
                       .citizenDocument(Document.builder()
                                            .build())
    ...
    @Test
    public void testGetDocumentDetailsWhenUploadedByCafcassCymruAndUploderRolenull() {

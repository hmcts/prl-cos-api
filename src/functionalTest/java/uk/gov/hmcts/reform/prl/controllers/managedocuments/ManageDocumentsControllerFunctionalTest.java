    ...
    public void givenCaseId_whenAboutToStartEndPoint_thenRespWithDocumentCategories() throws Exception {
        ...
        request
            ...
            .body("data.manageDocuments[0].value.documentParty", equalTo(null),
                  ...
                  "data.manageDocuments[0].value.documentCategories.list_items[8].code", equalTo(NOTICE_OF_HEARING),
                  "data.manageDocuments[0].value.documentCategories.list_items[9].code", equalTo(COURT_BUNDLE),
                  "data.manageDocuments[0].value.documentCategories.list_items[10].code", equalTo(CASE_SUMMARY),
                  "data.manageDocuments[0].value.documentCategories.list_items[11].code", equalTo(SAFEGUARDING_LETTER),
                  "data.manageDocuments[0].value.documentCategories.list_items[12].code", equalTo(SECTION7_REPORT),
                  "data.manageDocuments[0].value.documentCategories.list_items[13].code", equalTo(SECTION_37_REPORT),
                  "data.manageDocuments[0].value.documentCategories.list_items[14].code", equalTo(SIXTEEN_A_RISK_ASSESSMENT),
                  "data.manageDocuments[0].value.documentCategories.list_items[15].code", equalTo(GUARDIAN_REPORT),
                  "data.manageDocuments[0].value.documentCategories.list_items[16].code", equalTo(SPECIAL_GUARDIANSHIP_REPORT),
                  "data.manageDocuments[0].value.documentCategories.list_items[17].code", equalTo(OTHER_DOCS),
                  "data.manageDocuments[0].value.documentCategories.list_items[18].code", equalTo(EMAILS_TO_COURT_TO_REQUEST_HEARINGS_ADJOURNED),
                  "data.manageDocuments[0].value.documentCategories.list_items[19].code", equalTo(PUBLIC_FUNDING_CERTIFICATES),
                  "data.manageDocuments[0].value.documentCategories.list_items[20].code", equalTo(NOTICES_OF_ACTING_DISCHARGE),
                  "data.manageDocuments[0].value.documentCategories.list_items[21].code", equalTo(REQUEST_FOR_FAS_FORMS_TO_BE_CHANGED),
                  "data.manageDocuments[0].value.documentCategories.list_items[22].code", equalTo(WITNESS_AVAILABILITY),
                  "data.manageDocuments[0].value.documentCategories.list_items[23].code", equalTo(LETTERS_OF_COMPLAINTS),
                  "data.manageDocuments[0].value.documentCategories.list_items[24].code", equalTo(SPIP_REFERRAL_REQUESTS),
                  "data.manageDocuments[0].value.documentCategories.list_items[25].code", equalTo(HOME_OFFICE_DWP_RESPONSES),
                  "data.manageDocuments[0].value.documentCategories.list_items[26].code", equalTo("bulkScanQuarantine"),
                  "data.manageDocuments[0].value.documentCategories.list_items[27].code", equalTo(MEDICAL_REPORTS),
                  "data.manageDocuments[0].value.documentCategories.list_items[28].code", equalTo(DNA_REPORTS_EXPERT_REPORT),
                  "data.manageDocuments[0].value.documentCategories.list_items[29].code", equalTo(RESULTS_OF_HAIR_STRAND_BLOOD_TESTS),
                  "data.manageDocuments[0].value.documentCategories.list_items[30].code", equalTo(POLICE_DISCLOSURES),
                  "data.manageDocuments[0].value.documentCategories.list_items[31].code", equalTo(MEDICAL_RECORDS),
                  "data.manageDocuments[0].value.documentCategories.list_items[32].code", equalTo(DRUG_AND_ALCOHOL_TEST),
                  "data.manageDocuments[0].value.documentCategories.list_items[33].code", equalTo(POLICE_REPORT),
                  "data.manageDocuments[0].value.documentCategories.list_items[34].code", equalTo(SEC37_REPORT),
                  "data.manageDocuments[0].value.documentCategories.list_items[35].code", equalTo(ORDERS_SUBMITTED_WITH_APPLICATION),
                  "data.manageDocuments[0].value.documentCategories.list_items[36].code", equalTo(APPROVED_ORDERS),
                  "data.manageDocuments[0].value.documentCategories.list_items[37].code", equalTo(STANDARD_DIRECTIONS_ORDER),
                  "data.manageDocuments[0].value.documentCategories.list_items[38].code", equalTo(TRANSCRIPTS_OF_JUDGEMENTS),
                  "data.manageDocuments[0].value.documentCategories.list_items[39].code", equalTo(MAGISTRATES_FACTS_AND_REASONS),
                  "data.manageDocuments[0].value.documentCategories.list_items[40].code", equalTo(JUDGE_NOTES_FROM_HEARING),
                  "data.manageDocuments[0].value.documentCategories.list_items[41].code", equalTo(IMPORTANT_INFO_ABOUT_ADDRESS_AND_CONTACT),
                  "data.manageDocuments[0].value.documentCategories.list_items[42].code", equalTo(DNA_REPORTS_OTHER_DOCS),
                  "data.manageDocuments[0].value.documentCategories.list_items[43].code", equalTo(PRIVACY_NOTICE),
                  "data.manageDocuments[0].value.documentCategories.list_items[44].code", equalTo(SPECIAL_MEASURES),
                  "data.manageDocuments[0].value.documentCategories.list_items[45].code", equalTo(ANY_OTHER_DOC),
                  "data.manageDocuments[0].value.documentCategories.list_items[46].code", equalTo(POSITION_STATEMENTS),
                  "data.manageDocuments[0].value.documentCategories.list_items[47].code", equalTo(APPLICANT_STATEMENTS),
                  "data.manageDocuments[0].value.documentCategories.list_items[48].code", equalTo(RESPONDENT_STATEMENTS),
                  "data.manageDocuments[0].value.documentCategories.list_items[49].code", equalTo(OTHER_WITNESS_STATEMENTS)

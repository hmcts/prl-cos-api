...
@SpringBootTest(classes = {EmailControllerIntegrationTest.class, Application.class})
public class EmailControllerIntegrationTest extends IntegrationTest {

    @Value("${case.orchestration.service.base.uri}")
    protected String serviceUrl;

    private final String emailControllerEndPoint = "/email/send-solicitor-email";

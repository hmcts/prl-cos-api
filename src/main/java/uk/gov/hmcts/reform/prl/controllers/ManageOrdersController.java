...
import static com.microsoft.applicationinsights.boot.dependencies.apachecommons.lang3.ObjectUtils.defaultIfNull;
...
public class ManageOrdersController {
    ...
    public AboutToStartOrSubmitCallbackResponse saveOrderDetails(
        ...
        CaseData caseData = CaseUtils.getCaseData(callbackRequest.getCaseDetails(),objectMapper);
        Map<String, Object> caseDataUpdated = callbackRequest.getCaseDetails().getData();
        log.info("*** Case type of application in manage orders submission before : {}", caseDataUpdated.get("caseTypeOfApplication"));

...
public enum RespondentMustNotListEnum {
    ...
    notUseOrThreatenViolence("notUseOrThreatenViolence",
                             "Use or threaten violence against the applicant, and must not instruct, "
                                 + "encourage or in any way suggest that any other person should do so"),

    @JsonProperty("notIntimidateHarassOrPester")
    notIntimidateHarassOrPester("notIntimidateHarassOrPester",
    ...
    notDamageApplicantProperty("notDamageApplicantProperty",
                               "Must not damage, attempt to damage or threaten to damage any "
                                  + "property owned by or in the possession or control of the applicant, and must not "
                                  + "instruct, encourage or in any way suggest that any other person should do so"),

    @JsonProperty("notDamageApplicantAddressOrContents")
    notDamageApplicantAddressOrContents("notDamageApplicantAddressOrContents",
                                        "Must not damage, attempt to damage or threaten to damage the "
                                            + "property or contents of the property, and must not instruct, encourage "
                                            + "or in any way suggest that any other person should do so"),

    @JsonProperty("notAttendProperty")
    notAttendProperty("notAttendProperty",
                      "Must not go to, enter or attempt to enter the property"),

    @JsonProperty("notUseOrThreatenViolenceChildren")
    notUseOrThreatenViolenceChildren("notUseOrThreatenViolenceChildren",
                                     "Must not use or threaten violence against the relevant children, "
                                         + "and must not instruct, encourage or in any way suggest that any "
                                         + "other person should do so"),

    @JsonProperty("notIntimidateOrHarassChildren")
    notIntimidateOrHarassChildren("notIntimidateOrHarassChildren",
                                  "Must not intimidate, harass or pester the relevant children, and must "
                                      + "not instruct, encourage or in any way suggest that any other person should do so"),

    @JsonProperty("notContactChildren")
    notContactChildren("notContactChildren",
    ...
    notAttendSchool("notAttendSchool",

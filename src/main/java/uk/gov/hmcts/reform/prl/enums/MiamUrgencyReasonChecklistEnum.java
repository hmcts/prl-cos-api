...
@ComplexType(name = "MIAMUrgencyReasonChecklistEnum", generate = true)
...
public enum MiamUrgencyReasonChecklistEnum {
    ...
    @CCD(label = "Any delay caused by MIAM would cause significant risk of a miscarriage of justice")
    ...
    @CCD(label = "Any delay caused by MIAM would cause unreasonable hardship to the prospective applicant")
    ...
    @CCD(
            label = "There is a risk of unlawful removal of a child from the United Kingdom, or a risk of unlawful retention of a child who is currently outside England and Wales"
    )
    ...
    @CCD(label = "There is a risk of harm to a child")

    ...
    public DraftOrder getCurrentCreateDraftOrderDetails(CaseData caseData, String loggedInUserType) {
        ...
        return DraftOrder.builder().orderType(caseData.getCreateSelectOrderOptions())
            ...
            .otherDetails(OtherDraftOrderDetails.builder()
                              ...
                              .nameOfJudgeForReview(String.valueOf(caseData.getManageOrders().getNameOfJudgeAmendOrder()))
                              .nameOfLaForReview(String.valueOf(caseData.getManageOrders().getNameOfLaAmendOrder()))
                              .build())

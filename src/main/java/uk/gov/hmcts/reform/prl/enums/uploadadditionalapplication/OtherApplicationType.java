...
public enum OtherApplicationType {
    ...
    //Citizen AWP reasons
    @CCD(label = "C1 - Request the court grants you parental responsibility")
    ...
    @CCD(label = "C1 - Request the court appoints a guardian for child")
    ...
    @CCD(label = "C3 - Ask for an order authorizing search for, taking charge of and delivery of a child")
    ...
    @CCD(label = "C4 - Ask the court to order someone to provide information on where child is")
    ...
    @CCD(label = "C79 - Enforce a Child Arrangements Order")
    ...
    @CCD(label = "D89 - Ask the court to deliver papers to the other party")
    ...
    @CCD(label = "EX740 - Ask the court to prevent questioning in person - you accused someone")
    ...
    @CCD(label = "EX741 - Ask the court to prevent questioning in person - someone accused you")
    ...
    @CCD(label = "FP25 - Make a request to order a witness to attend court")
    ...
    @CCD(label = "FC600 - Request the court acts when someone in the case is disobeying a court order")
    ...
    @CCD(label = "N161 - Appeal a court order or ask for permission to appeal")
    ...
    @CCD(label = "FL403 - Apply to change, extend or cancel a non-molestation order or occupation order")
    ...
    @CCD(label = "FL407 - Request the court issues an arrest warrant")

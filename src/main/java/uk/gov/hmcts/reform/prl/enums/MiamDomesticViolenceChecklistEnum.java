...
@ComplexType(name = "MIAMDomesticViolenceChecklistEnum", generate = true)
@RequiredArgsConstructor
@JsonSerialize(using = CustomEnumSerializer.class)
public enum MiamDomesticViolenceChecklistEnum {

    @CCD(label = "Evidence that a prospective party has been arrested for a relevant domestic violence offence; ")
    ...
    @CCD(label = "Evidence of a relevant police caution for a domestic violence offence; ")
    ...
    @CCD(label = "Evidence of relevant criminal proceedings for a domestic violence offence which have not concluded; ")
    ...
    @CCD(label = "Evidence of a relevant conviction for a domestic violence offence; ")
    ...
    @CCD(label = "A court order binding a prospective party over in connection with a domestic violence offence; ")
    ...
    @CCD(label = "A relevant protective injunction; ")

    ...
    public static AutomatedHearingCaseData mappingAutomatedHearingTransactionRequest(CaseData caseData, UUID id) {
        ...
        try {
            ...
            automatedHearingCaseData = AutomatedHearingCaseData.automatedHearingCaseDataBuilder()
                ...
                .applicantsFL401(AutomatedHearingPartyDetails.automatedHearingPartyDetailsWith()
                                     ...
                                     .build())
                .respondentsFL401(AutomatedHearingPartyDetails.automatedHearingPartyDetailsWith()
                                      ...
                                      .build())
                .caseManagementLocation(AutomatedHearingCaseManagementLocation.automatedHearingCaseManagementLocationWith()
                ...
                .manageOrders(AutomatedHearingManageOrders.automatedHearingManageOrdersWith()
                                  .ordersHearingDetails(caseData.getManageOrders().getOrdersHearingDetails())
                                  .build())
                .attendHearing(AutomatedHearingAttendHearing.automatedHearingAttendHearingWith()

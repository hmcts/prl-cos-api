    ...
    public static QuarantineLegalDoc getQuarantineUploadDocument(String categoryId,
        ...
        return QuarantineLegalDoc.builder()
            ...
            .applicationsWithinProceedingsDocument(
                getDocumentByCategoryId(APPLICATIONS_WITHIN_PROCEEDINGS, categoryId, document))
            ...
            .applicationsFromOtherProceedingsDocument(
                getDocumentByCategoryId(APPLICATIONS_FROM_OTHER_PROCEEDINGS, categoryId, document))
            ...
            .requestForFasFormsToBeChangedDocument(
                getDocumentByCategoryId(REQUEST_FOR_FAS_FORMS_TO_BE_CHANGED, categoryId, document))
            ...
            .resultsOfHairStrandBloodTestsDocument(
                getDocumentByCategoryId(RESULTS_OF_HAIR_STRAND_BLOOD_TESTS, categoryId, document))
            ...
            .ordersSubmittedWithApplicationDocument(
                getDocumentByCategoryId(ORDERS_SUBMITTED_WITH_APPLICATION, categoryId, document))

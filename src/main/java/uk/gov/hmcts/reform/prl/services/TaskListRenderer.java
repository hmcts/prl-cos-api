...
public class TaskListRenderer {
    ...
    private List<TaskSection> groupInSections(List<Task> allTasks, CaseData caseData) {
        ...
        final TaskSection miamDetails = newSection(MIAM_DETAILS)
            .withInfo(new StringBuilder()
                ...
                .append("\n\n<div class='panel panel-border-wide govuk-!-font-size-16'>Mae llenwi’r adran Cyfarfod Asesu a Gwybodaeth")
                .append("am Gyfryngu (MIAM) yn ddewisol os bydd gorchymyn ")
                .append("cydsynio’n cael ei uwchlwytho wrth gyflwyno’r cais terfynol. Fel arall mae’n rhaid ei llenwi.</div>")
                .toString())
    ...
    private static List<TaskSection> generateTaskListV2(CaseData caseData, Map<Event, Task> tasks) {
        ...
        final TaskSection relationships = newSection("Relationships / Perthnasoedd")
                .withInfo(new StringBuilder()
                    ...
                    .append("\n\n<div class='panel panel-border-wide govuk-!-font-size-16'>Sicrhewch eich bod chi’n nodi ")
                    .append("sut fath o berthynas sydd gan y plant gyda’r holl bobl sy’n rhan o’r achos cyn i chi gyflwyno’r cais</div>")
                    .toString())
        ...
        final TaskSection miamDetails = newSection(MIAM_DETAILS)
                .withInfo(new StringBuilder()
                    .append("MIAM section is optional for final submit, if a consent order is uploaded and mandatory otherwise.")
                    .append("\n\n<div class='panel panel-border-wide govuk-!-font-size-16'>Mae adran MIAM yn ddewisol ")
                    .append("ar gyfer cyflwyniad terfynol, os caiff gorchymyn cydsynio ei lanlwytho ac yn orfodol fel arall.</div>")
                    .toString())
    ...
    private static List<TaskSection> generateTaskListV3(CaseData caseData, Map<Event, Task> tasks) {
        ...
        final TaskSection relationships = newSection("Relationships / Perthnasoedd")
            .withInfo(new StringBuilder()
                .append("Ensure relationship of children with all people on the case is captured, before submitting the application.")
                .append("\n\n<div class='panel panel-border-wide govuk-!-font-size-16'>Sicrhewch eich bod chi’n nodi sut fath ")
                .append("o berthynas sydd gan y plant gyda’r holl bobl sy’n rhan o’r achos cyn i chi gyflwyno’r cais</div>")
                .toString())
            .withTask(tasks.get(CHILDREN_AND_APPLICANTS))
            .withTask(tasks.get(CHILDREN_AND_RESPONDENTS))
            .withTask(tasks.get(CHILDREN_AND_OTHER_PEOPLE_IN_THIS_APPLICATION))
        ...
        final TaskSection miamDetails = newSection(MIAM_DETAILS)
            .withInfo(new StringBuilder()
                ...
                .append("\n\n<div class='panel panel-border-wide govuk-!-font-size-16'>Cyfarfod Gwybodaeth ac Asesu Cyfryngu (MIAM) mae'r")
                .append(" adran yn ddewisol ar gyfer cyflwyniad terfynol, Os caiff gorchymyn cydsynio ei lanlwytho ac yn orfodol fel arall.</div>")
                .toString())

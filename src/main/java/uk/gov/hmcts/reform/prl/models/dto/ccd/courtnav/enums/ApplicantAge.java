...
public enum ApplicantAge {
    ...
    @CCD(label = "18 years old or older. You can continue to apply using this form")
    ...
    @CCD(
            label = "16 to 18 years old. Someone over 18 must help you apply, such as a parent. They will also need to complete form 'FP9' to include with your application."
    )
    ...
    @CCD(
            label = "Under 16 years old. You will need permission from the court to apply. With the help of someone over 18, you must also complete form 'FP2' and they will need to complete form 'FP9' and include these with your application. Visit GOV.UK and search form ‘FP2’ and form 'FP9'"
    )

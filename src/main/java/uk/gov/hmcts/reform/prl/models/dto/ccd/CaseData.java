...
public class CaseData extends BaseCaseData implements MappableObject {
  ...
  private java.util.List<uk.gov.hmcts.ccd.sdk.type.ListValue<uk.gov.hmcts.reform.prl.models.dto.cafcass.OtherDocuments>> otherDocNotConf;
  @CCD(
  ...
  // ==== ccd-definition-converter: synthesised definition-only fields (retrofit) ====
  @JsonIgnore
  public Object getRestrictedDocuments() {
    return getReviewDocuments().getRestrictedDocuments();
  }
  @JsonIgnore
  public Object getConfidentialDocuments() {
    return getReviewDocuments().getConfidentialDocuments();
  }
  @JsonIgnore
  public Object getMessages() {
    return getSendOrReplyMessage().getMessages();
  }
  @JsonIgnore
  public Object getAdditionalOrderDocuments() {
    return getManageOrders().getAdditionalOrderDocuments();
  }
  @JsonIgnore
  public Object getConfidentialCheckFailed() {
    return getServiceOfApplication().getConfidentialCheckFailed();
  }
  @JsonIgnore
  public Object getServedDocumentsDetailsList() {
    return getServiceOfDocuments().getServedDocumentsDetailsList();
  }
  // ==== end synthesised definition-only fields ====
}

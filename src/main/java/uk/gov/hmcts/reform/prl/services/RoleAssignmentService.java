...
public class RoleAssignmentService {
    ...
    public void createRoleAssignment(String authorization,
        ...
        if (null != actorId) {
            if (null != roleAssignmentDto.getLegalAdviserList() || null != roleAssignmentDto.getLegalAdviser()) {
    ...
    private String populateActorIdFromDto(String authorization, RoleAssignmentDto roleAssignmentDto) {
        ...
        } else if (null != roleAssignmentDto.getLegalAdviser()) {
            return roleAssignmentDto.getLegalAdviser().getIdamId();
    ...
    public Map<String, String> fetchIdamAmRoles(String authorisation, String emailId) {
        ...
        final int[] i = {0};
        roleAssignmentServiceResponse.getRoleAssignmentResponse().forEach(

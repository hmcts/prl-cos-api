...
public class ManageOrdersUtils {
    ...
    private static final String[] HEARING_ORDER_IDS_NEED_SINGLE_HEARING =
        {"noticeOfProceedingsParties","noticeOfProceedingsNonParties","noticeOfProceedings", "noticeOfHearingParties",
            "noticeOfHearing"};
    ...
    public static final String[] PROHIBITED_ORDER_IDS_FOR_SOLICITORS = {"noticeOfProceedings","noticeOfProceedingsParties",
        "noticeOfProceedingsNonParties", "standardDirectionsOrder","directionOnIssue", "noticeOfHearingParties",
        "noticeOfHearing"};

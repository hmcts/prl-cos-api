...
public class FL404 {
    ...
    private final String fl404bRespondentNotIntimidate;
    private final String fl404bRespondentNotToTelephone;
    private final String fl404bRespondentNotToDamageOrThreat;
    private final String fl404bRespondentNotToDamage;
    private final String fl404bRespondentNotToEnterProperty;
    private final String fl404bRespondentNotToThreatChild;
    private final String fl404bRespondentNotHarassOrIntimidate;
    private final String fl404bRespondentNotToTelephoneChild;
    private final String fl404bRespondentNotToEnterSchool;

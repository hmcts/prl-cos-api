...
public enum CombinedC2AdditionalOrdersRequested {
    ...
    C2_DELAY_CANCEL_HEARING_DATE("C2_DELAY_OR_CANCEL_HEARING_DATE",
    ...
    C2_CHILD_ARRANGEMENTS_ORDER_TO_LIVE_SPEND_TIME("C2_CHILD_ARRANGEMENTS_ORDER_TO_LIVE_WITH_OR_SPEND_TIME",
    ...
    C2_SUBMIT_EVIDENCE_COURT_NOT_REQUESTED("C2_SUBMIT_EVIDENCE_THE_COURT_HAS_NOT_REQUESTED",
    ...
    C2_REQUEST_TO_WITHDRAW_APPLICATION("C2_REQUEST_TO_WITHDRAW_AN_APPLICATION",
                                       "C2 - Request to withdraw an application"),
    @JsonProperty("C2_REQUEST_TO_APPOINT_AN_EXPERT")
    C2_ASK_COURT_FOR_APPOINTING_EXPERT("C2_REQUEST_TO_APPOINT_AN_EXPERT",
                                       "C2 - Ask the court to appoint an expert"),
    @JsonProperty("C2_PERMISSION_FOR_AN_APPLICATION_IF_COURT_PREVIOUSLY_STOPPED_YOU")
    C2_PERMISSION_FOR_APPLICATION("C2_PERMISSION_FOR_AN_APPLICATION_IF_COURT_PREVIOUSLY_STOPPED_YOU",

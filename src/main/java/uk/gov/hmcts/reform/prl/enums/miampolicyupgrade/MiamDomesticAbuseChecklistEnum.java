...
@ComplexType(name = "MIAMDomesticAbuseChecklistEnum", generate = true)
...
public enum MiamDomesticAbuseChecklistEnum {
    ...
    @CCD(
            label = "A letter from an independent domestic violence advisor (IDVA) confirming that they are providing or have provided support to a prospective party."
    )

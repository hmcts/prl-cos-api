 ...
 *
 * @param <R> the type of the object to be returned after filtering
 */
public interface StaffResponseFilter<R> {
     ...
     * @return an Optional containing the transformed object of type R if the filter criteria are met, otherwise an empty Optional
     */

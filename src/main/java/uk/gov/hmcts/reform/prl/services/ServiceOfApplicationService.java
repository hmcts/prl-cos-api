...
public class ServiceOfApplicationService {
    ...
    public Map<String, Object> getSoaCaseFieldsMap(CaseDetails caseDetails) {
        ...
        log.info("sentDocumentPlaceHolder {}", caseDataUpdated.get("sentDocumentPlaceHolder"));
        ...
        log.info("SOA caseTypeOfApplication {}", caseDataUpdated.get("caseTypeOfApplication"));

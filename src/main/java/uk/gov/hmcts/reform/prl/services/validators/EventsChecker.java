...
public class EventsChecker {
    ...
    @Autowired
    private OtherChildrenNotInTheCaseChecker otherChildrenNotInTheCaseChecker;
    @Autowired
    ...
    public void init() {
        ...
        eventStatus.put(OTHER_CHILDREN_IN_NOT_THE_CASE, otherChildrenNotInTheCaseChecker);

...
public enum RejectReasonEnum {
    ...
    consentOrderNotProvided("consentOrderNotProvided","Consent Order not provided", "Consent Order not provided - welsh",
    ...
    miamCertificateNotProvided("miamCertificateNotProvided","MIAM certificate not provided", "MIAM certificate not provided - welsh",
    ...
    incompleteEvidenceOfMiamExamption("incompleteEvidenceOfMiamExamption","Evidence of MIAM exemption incomplete",
        "Evidence of MIAM exemption incomplete - welsh",
                         "Evidence of MIAM "
    ...
    confidentalDetailListed("confidentalDetailListed","Confidential detail listed", "Confidential detail listed - welsh",
    ...
    section9114OrderInForce("section9114OrderInForce","Section 91(14) order in force", "Section 91(14) order in force - welsh",
    ...
    permissionIsNeeded("permissionIsNeeded","Permission is needed to make application", "Permission is needed to make application - welsh",
    ...
    parentalResponsibility("parentalResponsibility","Parental responsibility", "Parental responsibility - welsh",
    ...
    applicationIncomplete("applicationIncomplete","Application incomplete", "Application incomplete - welsh",
    ...
    clarificationNeeded("clarificationNeeded","Clarification needed", "Clarification needed - welsh",
    ...
    otherReason("otherReason","Other reason", "Other reason - welsh", "Other reason\n\n\n"),;

    private final String id;
    private final String displayedValue;
    private final String welshDisplayedValue;

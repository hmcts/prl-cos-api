...
public class DraftAnOrderService {
    ...
    private DraftOrder getCurrentOrderDetails(CaseData caseData) {
        if (uploadAnOrder.equals(caseData.getManageOrdersOptions())) {
            String flagSelectedOrderId = manageOrderService.getSelectedOrderInfoForUpload(caseData);
            String flagSelectedOrder = manageOrderService.getSelectedOrderInfoForUpload(caseData);

...
@ComplexType(name = "MIAMPolicyUpgradeUrgencyReasonChecklistEnum", generate = true)
@RequiredArgsConstructor
@JsonSerialize(using = CustomEnumSerializer.class)
public enum MiamUrgencyReasonChecklistEnum {

    @CCD(
            label = "There is risk to the life, liberty or physical safety of the prospective applicant or his or her family or his or her home."
    )
    ...
    @CCD(label = "Any delay caused by attending a MIAM would cause a risk of harm to a child.")
    ...
    @CCD(
            label = "Any delay caused by attending a MIAM would cause a risk of unlawful removal of a child from the United Kingdom, or a risk of unlawful retention of a child who is currently outside England and Wales."
    )
    ...
    @CCD(label = "Any delay caused by attending a MIAM would cause a significant risk of a miscarriage of justice.")
    ...
    @CCD(
            label = "Any delay caused by attending a MIAM would cause significant financial hardship to the prospective applicant."
    )
    ...
    @CCD(
            label = "Any delay caused by attending a MIAM would cause irretrievable problems in dealing with the dispute (including the irretrievable loss of significant evidence)."
    )

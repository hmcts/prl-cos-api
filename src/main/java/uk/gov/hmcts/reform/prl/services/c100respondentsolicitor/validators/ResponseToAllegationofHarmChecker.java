...
import static uk.gov.hmcts.reform.prl.enums.c100respondentsolicitor.RespondentEventErrorsEnum.RESPONSE_TO_ALLEGATION_OF_HARM;
...
public class ResponseToAllegationofHarmChecker implements RespondentEventChecker{
    ...
    public boolean isFinished(PartyDetails respondingParty) {
        ...
        if (response.isPresent()) {
            ...
            if (respondentAllegationsOfHarm.isPresent() && checkAllegationsOfHarmManadatoryCompleted(
                ...
                respondentTaskErrorService.removeError(RESPONSE_TO_ALLEGATION_OF_HARM);
                return true;
            }
        }
        respondentTaskErrorService.addEventError(
            RESPOND_ALLEGATION_OF_HARM,
            RESPONSE_TO_ALLEGATION_OF_HARM,
            RESPONSE_TO_ALLEGATION_OF_HARM.getError()
        );
        return false;
    }

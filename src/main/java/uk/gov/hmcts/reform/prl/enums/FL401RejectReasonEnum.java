...
public enum FL401RejectReasonEnum {
    ...
    consentOrderNotProvided("consentOrderNotProvided","Consent Order not provided",
        "Consent Order not provided - welsh",
    ...
    witnessStatementNotProvided("witnessStatementNotProvided","Witness statement not provided",
        "Witness statement not provided - welsh",
    ...
    confidentalDetailListed("confidentalDetailListed","Confidential detail listed",
        "Confidential detail listed - welsh",
    ...
    section9114OrderInForce("section9114OrderInForce","Section 91(14) order in force",
        "Section 91(14) order in force - welsh",
    ...
    permissionIsNeeded("permissionIsNeeded","Permission is needed to make application",
        "Permission is needed to make application - welsh",
    ...
    parentalResponsibility("parentalResponsibility","Parental responsibility",
        "Parental responsibility - welsh",
    ...
    applicationIncomplete("applicationIncomplete","Application incomplete",
        "Application incomplete - welsh",
    ...
    applicationIncorrect("applicationIncorrect","Application incorrect",
    ...
    clarificationNeeded("clarificationNeeded","Clarification needed",
        "Clarification needed - welsh",

...
public enum MIAMDomesticViolenceChecklistEnum {
    ...
    MIAMDomesticViolenceChecklistEnum_Value_1("Evidence that a prospective party has been arrested for a relevant domestic violence offence;"),
    ...
    MIAMDomesticViolenceChecklistEnum_Value_3("Evidence of relevant criminal proceedings for a domestic violence offence which have not concluded;"),
    ...
    MIAMDomesticViolenceChecklistEnum_Value_5("A court order binding a prospective party over in connection with a domestic violence offence;"),
    @JsonProperty("miamDomesticViolenceChecklistEnum_Value_6")
    MIAMDomesticViolenceChecklistEnum_Value_6("A domestic violence protection notice issued under section 24 of the Crime and Security Act 2010 against a prospective party;"),
    ...
    MIAMDomesticViolenceChecklistEnum_Value_22("Evidence which demonstrates that a prospective party has been, or is at risk of being, the victim of domestic violence by another prospective party in the form of abuse which relates to financial matters.");

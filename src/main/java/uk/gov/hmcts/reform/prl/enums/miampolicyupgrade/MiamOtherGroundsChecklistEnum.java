...
@ComplexType(name = "MIAMPolicyUpgradeOtherGroundsChecklistEnum", generate = true)
...
public enum MiamOtherGroundsChecklistEnum {
    ...
    @CCD(
            label = "(i) The prospective applicant is not able to attend a MIAM online or by video-link; and (ii) there is no authorised family mediator with an office within 15 miles of the prospective applicant’s home."
    )
    ...
    @CCD(
            label = "The prospective applicant cannot attend a MIAM because the prospective applicant is (i) in prison or any other institution in which the prospective applicant is required to be detained and facilities cannot be made available for them to attend a MIAM online or by video link; or (ii) subject to conditions of bail that prevent contact with the other person; or (iii) subject to a licence with a prohibited contact requirement in relation to\nthe other person."
    )

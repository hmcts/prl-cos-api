...
public class PrlAppsConstants {
    ...
    public static final String INTERPRETER_REQUIRED_TEXT =
    ...
    public static final String SOA_FL415_FILENAME_WELSH = "CY_FL415.pdf";
    ...
    public static final String SOS_CONFIRMATION_BODY_PREFIX = "### Beth fydd yn digwydd nesaf <br/>What happens next \n\n "
        + System.lineSeparator()
        + "Os yw Cafcass yn rhan o’r achos, byddant yn darparu llythyr diogelu i’r llys.<br/>"
    ...
    public static final String WA_ALL_SELECTED_FLAGS = "selectedFlags";

...
public class PrlAppsConstants {
    ...
    public static final String Annex_1_FILENAME = "Annex 1 - Confidential contact details notice.pdf";
    public static final String Annex_1_FILENAME_WELSH = "Annex 1 - Confidential contact details notice - welsh.pdf";

...
public class PrlAppsConstants {
    ...
    public static final String[] HEARING_PAGE_NEEDED_ORDER_IDS = {"nonMolestation","powerOfArrest","occupation","generalForm",
        "blank","amendDischargedVaried","noticeOfProceedings","childArrangementsSpecificProhibitedOrder"};

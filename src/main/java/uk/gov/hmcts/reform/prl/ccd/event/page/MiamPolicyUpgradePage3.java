 ...
 *
 * <p>Wizard page {@code 3} of event {@code miamPolicyUpgrade}.
 */
public final class MiamPolicyUpgradePage3 {
    private MiamPolicyUpgradePage3() {
    }
    ...
    public static void apply(
        ...
        fields.complex(CaseData::getMiamPolicyUpgradeDetails)
                    .optional(MiamPolicyUpgradeDetails::getMpuDomesticAbuseEvidences)
                    .optional(MiamPolicyUpgradeDetails::getMpuIsDomesticAbuseEvidenceProvided).done();
        fields.complex(CaseData::getCaseDataExtra)
        ...
        fields.complex(CaseData::getMiamPolicyUpgradeDetails)
                    ...
                    .optional(MiamPolicyUpgradeDetails::getMpuNoDomesticAbuseEvidenceReason)
                    .fieldShowCondition("mpuIsDomesticAbuseEvidenceProvided=\"No\"").done();
    }
}

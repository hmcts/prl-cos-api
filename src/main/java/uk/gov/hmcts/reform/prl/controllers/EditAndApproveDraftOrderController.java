...
public class EditAndApproveDraftOrderController {
    ...
    @GetMapping(path = "/populate-draft-order-dropdown", consumes = APPLICATION_JSON, produces = APPLICATION_JSON)
    ...
    public AboutToStartOrSubmitCallbackResponse generateDraftOrderDropDown(
        ...
        @RequestParam(value = "waOrderName", required = false) String waOrderName,
        ...
        if (authorisationService.isAuthorized(authorisation,s2sToken)) {
            ...
            log.info("waOrderName {}", waOrderName);

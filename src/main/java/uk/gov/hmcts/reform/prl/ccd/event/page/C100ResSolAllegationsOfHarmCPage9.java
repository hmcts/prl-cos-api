 ...
 *
 * <p>Wizard page {@code 9} of event {@code c100ResSolAllegationsOfHarmC}.
 */
public final class C100ResSolAllegationsOfHarmCPage9 {
    private C100ResSolAllegationsOfHarmCPage9() {
    }
    ...
    public static void apply(
        ...
        fields.complex(CaseData::getRespondentSolicitorData)
                    .complex(RespondentSolicitorData::getRespondentAllegationsOfHarmData)
                    .optional(RespondentAllegationsOfHarmData::getRespWhichChildrenAreRiskFinancialAbuse)
                    .fieldShowCondition("respAllChildrenAreRiskFinancialAbuse=\"No\"").done().done();
        fields.complex(CaseData::getRespondentSolicitorData)
                    .complex(RespondentSolicitorData::getRespondentAllegationsOfHarmData)
                    .optional(RespondentAllegationsOfHarmData::getRespChildFinancialAbuse).done().done();
    }
}

...
public class SendLetterApiConsumerTest {
    ...
    private RequestResponsePact generateSendLetterPact(PactDslWithProvider builder) throws JsonProcessingException {

        String letterType = "type";
        ...
        letterWithPdfsRequest = new LetterWithPdfsRequest(documents,letterType,additionalData);

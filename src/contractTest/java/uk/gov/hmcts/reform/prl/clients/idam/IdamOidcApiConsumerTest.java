...
public class IdamOidcApiConsumerTest extends IdamConsumerTestBase {
    ...
    public RequestResponsePact generatePactForUserInfo(PactDslWithProvider builder) throws JSONException {
        ...
        return builder
            ...
            .uponReceiving("A request for a UserInfo from prl cos api")
            .path("/o/userinfo")
            .method("GET")
    ...
    public RequestResponsePact generatePactForToken(PactDslWithProvider builder) {
        ...
        return builder
            ...
            .uponReceiving("Provider receives a POST /o/token request from prl cos api")
            .path("/o/token")
    ...
    private PactDslJsonBody createUserDetailsResponse() {
        ...
        return new PactDslJsonBody()
            .stringType("sub", "61")
            .stringType("uid", "prl_pact_user@mailinator.com")

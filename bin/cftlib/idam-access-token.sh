#!/bin/bash
# usage: idam-access-token idam-api-host prl-cos-client-secret username password
# Requires jq to be installed

if [[ $# -ne 4 ]]; then
  echo "Error: incorrect number of arguments"
  echo "Usage: idam-access-token.sh idam-api-host prl-cos-client-secret username password"
  exit 1
fi
